...
loader.start2 = function()
	...
	createNativeThread(function()
		...
		until PlayerGui:FindFirstChild("RUNSEC")

		print("Injected!")

		local GUI = PlayerGui:FindFirstChild("RUNSEC")
		GUI.Name = "RobloxGui"
...
img_BtnMax.setSize(70,20)
img_BtnMax.setPosition(390 -75,4)
...
img_BtnMax.onClick = function()
	...
	replaceString("+execute|".. string.rep(" ", 999) .. string.char(0), ExecuteString("-execute|"..
		txt.Lines.Text), true)
end
